...
4. Set the colour of an event to make it stand out in the planner.
5. Allow certain events to be overlapped and others cannot. (Ex. You can workout on your birthday, but you can’t workout during a party.)
6. Allow users to define an event that they want fitted in their schedule
7. Allow events to have different priorities that the user defines., Ex. Hospital visits would be allowed to overwrite a party event.
